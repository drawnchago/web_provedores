...
export class WorkOrderDetailComponent implements OnInit {
  ...
  action: string;
  constructor(public dialog: MatDialog, public dialogRef: MatDialogRef<WorkOrderDetailComponent>,
  ...
  */
    /* this.oppService.updateStatusOrders(this.work_order.id,this.user.id).subscribe(response=>{
  ...
  addPiece() {
    console.log(this.work_order.type_bomb_id)
    this.dialog.open(AddPieceDialogComponent, {
      data: this.work_order,
      width: '60%'
    });
